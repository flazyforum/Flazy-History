...
if (isset($_POST['add_rank']))
{
	...
	redirect(forum_link('admin/ranks.php'), $lang_admin_ranks['Rank added'].' '.$lang_admin_common['Redirect']);
}
...
else if (isset($_POST['update']))
{
	...
	redirect(forum_link('admin/ranks.php'), $lang_admin_ranks['Rank updated'].' '.$lang_admin_common['Redirect']);
}
...
else if (isset($_POST['remove']))
{
	...
	redirect(forum_link('admin/ranks.php'), $lang_admin_ranks['Rank removed'].' '.$lang_admin_common['Redirect']);
}
...
?>
	...
	<div class="main-content main-frm">
		<div class="ct-box">
			<p><?php printf($lang_admin_ranks['Add rank intro'], '<strong><a href="'.forum_link('admin/settings.php?section=features').'">'.$lang_admin_common['Settings'].' » '.$lang_admin_common['Features'].'</a></strong>') ?></p>
		</div>
		<form class="frm-form" method="post" accept-charset="utf-8" action="<?php echo forum_link('admin/ranks.php') ?>?action=foo">
			<div class="hidden">
				<input type="hidden" name="csrf_token" value="<?php echo generate_form_token(forum_link('admin/ranks.php').'?action=foo') ?>" />
			</div>
