...
if (isset($_REQUEST['add_ban']) || isset($_GET['edit_ban']))
{
	...
	$forum_page['crumbs'][] = array($lang_admin_common['Bans'], forum_link('admin/bans.php'));
...
else if (isset($_POST['add_edit_ban']))
{
	...
	redirect(forum_link('admin/bans.php'), (($_POST['mode'] == 'edit') ? $lang_admin_bans['Ban edited'] : $lang_admin_bans['Ban added']).' '.$lang_admin_common['Redirect']);
}
...
else if (isset($_GET['del_ban']))
{
	...
	redirect(forum_link('admin/bans.php'), $lang_admin_bans['Ban removed'].' '. $lang_admin_common['Redirect']);
}


// Setup the form
$forum_page['group_count'] = $forum_page['item_count'] = $forum_page['fld_count'] = 0;
$forum_page['form_action'] = forum_link('admin/bans.php').'?action=more';
