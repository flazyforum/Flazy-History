...
?>
	...
	<div class="main-content main-frm">
		...
		<form class="frm-form" method="post" accept-charset="utf-8" action="<?php echo forum_link('admin/groups.php') ?>">
			<div class="hidden">
				<input type="hidden" name="csrf_token" value="<?php echo generate_form_token(forum_link('admin/groups.php')) ?>" />
...
<?php ($hook = get_hook('agr_add_edit_group_pre_basic_details_fieldset')) ? eval($hook) : null; ?>
			<fieldset class="frm-group group<?php echo ++$forum_page['group_count'] ?>">
				...
				<div class="ct-box set<?php echo ++$forum_page['item_count'] ?>">
					<p><?php echo $lang_admin_groups['Group title head'] ?></p>
				</div>
<?php ($hook = get_hook('agr_add_edit_group_pre_group_title')) ? eval($hook) : null; ?>
				<div class="sf-set set<?php echo ++$forum_page['item_count'] ?>">
					<div class="sf-box text required">
						...
						<span class="fld-input"><input type="text" id="fld<?php echo $forum_page['fld_count'] ?>" name="req_title" size="25" maxlength="50" value="<?php if ($mode == 'edit') echo forum_htmlencode($group['g_title']); ?>" class="inputbox" /></span>
					</div>
				</div>
<?php ($hook = get_hook('agr_add_edit_group_pre_user_title')) ? eval($hook) : null; ?>
				<div class="sf-set set<?php echo ++$forum_page['item_count'] ?>">
					<div class="sf-box text">
						...
						<span class="fld-input"><input type="text" id="fld<?php echo $forum_page['fld_count'] ?>" name="user_title" size="25" maxlength="50" value="<?php echo forum_htmlencode($group['g_user_title']) ?>" class="inputbox" /></span>
					</div>
				</div>
...
<?php endif; ($hook = get_hook('agr_add_edit_group_pre_permissions_fieldset')) ? eval($hook) : null; ?>
				<fieldset class="frm-group group<?php echo ++$forum_page['group_count'] ?>">
					...
					<div class="ct-box set<?php echo ++$forum_page['item_count'] ?>">
						<p><?php echo $lang_admin_groups['Group perms head'] ?></p>
					</div>
...
<?php ($hook = get_hook('agr_add_edit_group_pre_allow_moderate_checkbox')) ? eval($hook) : null; ?>
							<div class="mf-item">
								<span class="fld-input"><input type="checkbox" id="fld<?php echo ++$forum_page['fld_count'] ?>" name="moderator" value="1"<?php if ($group['g_moderator']) echo ' checked="checked"' ?> /></span>
...
<?php ($hook = get_hook('agr_add_edit_group_pre_allow_mod_edit_profiles_checkbox')) ? eval($hook) : null; ?>
							<div class="mf-item">
								<span class="fld-input"><input type="checkbox" id="fld<?php echo ++$forum_page['fld_count'] ?>" name="mod_edit_users" value="1"<?php if ($group['g_mod_edit_users']) echo ' checked="checked"' ?> /></span>
...
<?php ($hook = get_hook('agr_add_edit_group_pre_allow_mod_edit_userbane_checkbox')) ? eval($hook) : null; ?>
							<div class="mf-item">
								<span class="fld-input"><input type="checkbox" id="fld<?php echo ++$forum_page['fld_count'] ?>" name="mod_rename_users" value="1"<?php if ($group['g_mod_rename_users']) echo ' checked="checked"' ?> /></span>
...
<?php ($hook = get_hook('agr_add_edit_group_pre_allow_mod_change_pass_checkbox')) ? eval($hook) : null; ?>
							<div class="mf-item">
								<span class="fld-input"><input type="checkbox" id="fld<?php echo ++$forum_page['fld_count'] ?>" name="mod_change_passwords" value="1"<?php if ($group['g_mod_change_passwords']) echo ' checked="checked"' ?> /></span>
...
<?php ($hook = get_hook('agr_add_edit_group_pre_allow_mod_ban_users_checkbox')) ? eval($hook) : null; ?>
							<div class="mf-item">
								<span class="fld-input"><input type="checkbox" id="fld<?php echo ++$forum_page['fld_count'] ?>" name="mod_ban_users" value="1"<?php if ($group['g_mod_ban_users']) echo ' checked="checked"' ?> /></span>
...
<?php ($hook = get_hook('agr_add_edit_group_pre_allow_read_board_checkbox')) ? eval($hook) : null; ?>
							<div class="mf-item">
								<span class="fld-input"><input type="checkbox" id="fld<?php echo ++$forum_page['fld_count'] ?>" name="read_board" value="1"<?php if ($group['g_read_board']) echo ' checked="checked"' ?> /></span>
...
<?php ($hook = get_hook('agr_add_edit_group_pre_allow_view_users_checkbox')) ? eval($hook) : null; ?>
							<div class="mf-item">
								<span class="fld-input"><input type="checkbox" id="fld<?php echo ++$forum_page['fld_count'] ?>" name="view_users" value="1"<?php if ($group['g_view_users']) echo ' checked="checked"' ?> /></span>
...
<?php ($hook = get_hook('agr_add_edit_group_pre_allow_post_replies_checkbox')) ? eval($hook) : null; ?>
							<div class="mf-item">
								<span class="fld-input"><input type="checkbox" id="fld<?php echo ++$forum_page['fld_count'] ?>" name="post_replies" value="1"<?php if ($group['g_post_replies']) echo ' checked="checked"' ?> /></span>
...
<?php ($hook = get_hook('agr_add_edit_group_pre_allow_post_topics_checkbox')) ? eval($hook) : null; ?>
							<div class="mf-item">
								<span class="fld-input"><input type="checkbox" id="fld<?php echo ++$forum_page['fld_count'] ?>" name="post_topics" value="1"<?php if ($group['g_post_topics']) echo ' checked="checked"' ?> /></span>
...
<?php ($hook = get_hook('agr_add_edit_group_pre_allow_edit_posts_checkbox')) ? eval($hook) : null; if ($group['g_id'] != FORUM_GUEST): ?>							<div class="mf-item">
								<span class="fld-input"><input type="checkbox" id="fld<?php echo ++$forum_page['fld_count'] ?>" name="edit_posts" value="1"<?php if ($group['g_edit_posts']) echo ' checked="checked"' ?> /></span>
...
<?php ($hook = get_hook('agr_add_edit_group_pre_allow_delete_posts_checkbox')) ? eval($hook) : null; ?>
							<div class="mf-item">
								<span class="fld-input"><input type="checkbox" id="fld<?php echo ++$forum_page['fld_count'] ?>" name="delete_posts" value="1"<?php if ($group['g_delete_posts']) echo ' checked="checked"' ?> /></span>
...
<?php ($hook = get_hook('agr_add_edit_group_pre_allow_delete_topics_checkbox')) ? eval($hook) : null; ?>
							<div class="mf-item">
								<span class="fld-input"><input type="checkbox" id="fld<?php echo ++$forum_page['fld_count'] ?>" name="delete_topics" value="1"<?php if ($group['g_delete_topics']) echo ' checked="checked"' ?> /></span>
								<label for="fld<?php echo $forum_page['fld_count'] ?>"><?php echo $lang_admin_groups['Allow delete topics label'] ?></label>
							</div>
<?php ($hook = get_hook('agr_fl_add_edit_group_pre_allow_poll_add_checkbox')) ? eval($hook) : null; ?>
							<div class="mf-item">
								<span class="fld-input"><input type="checkbox" id="fld<?php echo ++$forum_page['fld_count'] ?>" name="poll_add" value="1"<?php if ($group['g_poll_add']) echo ' checked="checked"' ?>/></span>
								<label for="fld<?php echo $forum_page['fld_count'] ?>"><?php echo $lang_admin_groups['Allow poll add label'] ?></label>
							</div>
<?php ($hook = get_hook('agr_add_edit_group_pre_allow_set_user_title_checkbox')) ? eval($hook) : null; ?>
							<div class="mf-item">
								<span class="fld-input"><input type="checkbox" id="fld<?php echo ++$forum_page['fld_count'] ?>" name="set_title" value="1"<?php if ($group['g_set_title']) echo ' checked="checked"' ?> /></span>
...
<?php endif; ($hook = get_hook('agr_add_edit_group_pre_allow_search_checkbox')) ? eval($hook) : null; ?>
							<div class="mf-item">
								<span class="fld-input"><input type="checkbox" id="fld<?php echo ++$forum_page['fld_count'] ?>" name="search" value="1"<?php if ($group['g_search']) echo ' checked="checked"' ?> /></span>
...
<?php ($hook = get_hook('agr_add_edit_group_pre_allow_search_users_checkbox')) ? eval($hook) : null; ?>
							<div class="mf-item">
								<span class="fld-input"><input type="checkbox" id="fld<?php echo ++$forum_page['fld_count'] ?>" name="search_users" value="1"<?php if ($group['g_search_users']) echo ' checked="checked"' ?> /></span>
...
<?php ($hook = get_hook('agr_add_edit_group_pre_allow_send_email_checkbox')) ? eval($hook) : null; if ($group['g_id'] != FORUM_GUEST): ?>
							<div class="mf-item">
								<span class="fld-input"><input type="checkbox" id="fld<?php echo ++$forum_page['fld_count'] ?>" name="send_email" value="1"<?php if ($group['g_send_email']) echo ' checked="checked"' ?> /></span>
								<label for="fld<?php echo $forum_page['fld_count'] ?>"><?php echo $lang_admin_groups['Allow send email label'] ?></label>
<?php endif; ?>							</div>
<?php ($hook = get_hook('agr_add_edit_group_pre_allow_reputation_checkbox')) ? eval($hook) : null; 

if ($group['g_id'] != FORUM_GUEST && $forum_config['o_rep_enabled']): ?>
							<div class="mf-item">
								<span class="fld-input"><input type="checkbox" id="fld<?php echo ++$forum_page['fld_count'] ?>" name="rep_enable" value="1"<?php if ($group['g_rep_enable']) echo ' checked="checked"' ?> /></span>
								<label for="fld<?php echo $forum_page['fld_count'] ?>"><?php echo $lang_admin_groups['Allow reputation label'] ?></label>
							</div>
						</div>
<?php endif; ($hook = get_hook('agr_fl_add_edit_group_pre_user_permissions_fieldset_end')) ? eval($hook) : null; ?>
						</fieldset>
				</fieldset>
<?php
...
?>
<?php ($hook = get_hook('agr_fl_add_edit_group_pre_rep_fieldset')) ? eval($hook) : null; ?>
			<fieldset class="frm-group group<?php echo ++$forum_page['group_count'] ?>">
				<legend class="group-legend"><span><?php echo $lang_admin_groups['Restrictions'] ?></span></legend>
				<div class="ct-box set<?php echo ++$forum_page['item_count'] ?>">
					<p><?php echo $lang_admin_groups['Group rep head'] ?></p>
				</div>
<?php ($hook = get_hook('agr_fl_add_edit_group_pre_rep_plus_interval')) ? eval($hook) : null; ?>
				<div class="sf-set set<?php echo ++$forum_page['item_count'] ?>">
					<div class="sf-box text">
						<label for="fld<?php echo ++$forum_page['fld_count'] ?>"><span><?php echo $lang_admin_groups['Min messages plus'] ?></span> <small><?php echo $lang_admin_groups['Min messages plus help'] ?></small></label><br />
						<span class="fld-input"><input type="text" id="fld<?php echo $forum_page['fld_count'] ?>" name="rep_plus_min" size="5" maxlength="4" value="<?php echo $group['g_rep_plus_min'] ?>" class="inputbox" /></span>
					</div>
				</div>
<?php ($hook = get_hook('agr_fl_add_edit_group_pre_rep_minus_interval')) ? eval($hook) : null; ?>
				<div class="sf-set set<?php echo ++$forum_page['item_count'] ?>">
					<div class="sf-box text">
						<label for="fld<?php echo ++$forum_page['fld_count'] ?>"><span><?php echo $lang_admin_groups['Min messages minus'] ?></span> <small><?php echo $lang_admin_groups['Min messages minus help'] ?></small></label><br />
						<span class="fld-input"><input type="text" id="fld<?php echo $forum_page['fld_count'] ?>" name="rep_minus_min" size="5" maxlength="4" value="<?php echo $group['g_rep_minus_min'] ?>" class="inputbox" /></span>
					</div>
				</div>
<?php endif; ?>
				</fieldset>
...
<?php ($hook = get_hook('agr_add_edit_group_pre_flood_fieldset')) ? eval($hook) : null; ?>
			<fieldset class="frm-group group<?php echo ++$forum_page['group_count'] ?>">
				<legend class="group-legend"><span><?php echo $lang_admin_groups['Restrictions'] ?></span></legend>
				<div class="ct-box set<?php echo ++$forum_page['item_count'] ?>">
					<p><?php echo $lang_admin_groups['Group flood head'] ?></p>
				</div>
<?php ($hook = get_hook('agr_add_edit_group_pre_post_interval')) ? eval($hook) : null; ?>
				<div class="sf-set set<?php echo ++$forum_page['item_count'] ?>">
					<div class="sf-box text">
						...
						<span class="fld-input"><input type="text" id="fld<?php echo $forum_page['fld_count'] ?>" name="post_flood" size="5" maxlength="4" value="<?php echo $group['g_post_flood'] ?>" class="inputbox" /></span>
					</div>
				</div>
<?php ($hook = get_hook('agr_add_edit_group_pre_search_interval')) ? eval($hook) : null; ?>
				<div class="sf-set set<?php echo ++$forum_page['item_count'] ?>">
					<div class="sf-box text">
						...
						<span class="fld-input"><input type="text" id="fld<?php echo $forum_page['fld_count'] ?>" name="search_flood" size="5" maxlength="4" value="<?php echo $group['g_search_flood'] ?>" class="inputbox" /></span>
					</div>
				</div>
<?php
...
?>
				<div class="sf-set set<?php echo ++$forum_page['item_count'] ?>">
					<div class="sf-box text">
						...
						<span class="fld-input"><input type="text" id="fld<?php echo $forum_page['fld_count'] ?>" name="email_flood" size="5" maxlength="4" value="<?php echo $group['g_email_flood'] ?>" class="inputbox" /></span>
					</div>
				</div>
<?php
...
else if (isset($_POST['add_edit_group']))
{
	...
	$poll_add = (isset($_POST['poll_add']) && $_POST['poll_add'] == '1') || $is_admin_group ? '1' : '0';
	...
	$reputation = (isset($_POST['rep_enable']) && $_POST['rep_enable'] == '1') || $is_admin_group ? '1' : '0';
	...
	else
	{
		...
		$query = array(
			'UPDATE'	=> 'groups',
			'SET'		=> 'g_title=\''.$forum_db->escape($title).'\', g_user_title='.$user_title.', g_moderator='.$moderator.', g_mod_edit_users='.$mod_edit_users.', g_mod_rename_users='.$mod_rename_users.', g_mod_change_passwords='.$mod_change_passwords.', g_mod_ban_users='.$mod_ban_users.', g_read_board='.$read_board.', g_view_users='.$view_users.', g_post_replies='.$post_replies.', g_post_topics='.$post_topics.', g_edit_posts='.$edit_posts.', g_delete_posts='.$delete_posts.', g_delete_topics='.$delete_topics.', g_poll_add='.$poll_add.', g_set_title='.$set_title.', g_search='.$search.', g_search_users='.$search_users.', g_send_email='.$send_email.', g_rep_enable='.$reputation.', g_rep_plus_min='.$rep_plus_min.', g_rep_minus_min='.$rep_minus_min.', g_post_flood='.$post_flood.', g_search_flood='.$search_flood.', g_email_flood='.$email_flood,
			'WHERE'		=> 'g_id='.$group_id
		);
	...
	redirect(forum_link('admin/groups.php'), (($_POST['mode'] == 'edit') ? $lang_admin_groups['Group edited'] : $lang_admin_groups['Group added']).' '.$lang_admin_common['Redirect']);
}
...
else if (isset($_POST['set_default_group']))
{
	...
	redirect(forum_link('admin/groups.php'), $lang_admin_groups['Default group set'].' '.$lang_admin_common['Redirect']);
}
...
else if (isset($_GET['del_group']))
{
	...
	if (isset($_POST['del_group_cancel']))
		redirect(forum_link('admin/groups.php'), $lang_admin_common['Cancel redirect']);
	...
	if (!$forum_db->num_rows($result) || isset($_POST['del_group']))
	{
		...
		redirect(forum_link('admin/groups.php'), $lang_admin_groups['Group removed'].' '.$lang_admin_common['Redirect']);
	}
...
?>
	...
	<div class="main-content main-frm">
		<form class="frm-form" method="post" accept-charset="utf-8" action="<?php echo forum_link('admin/groups.php') ?>?del_group=<?php echo $group_id ?>">
			<div class="hidden">
				<input type="hidden" name="csrf_token" value="<?php echo generate_form_token(forum_link('admin/groups.php').'?del_group='.$group_id) ?>" />
			</div>
...
?>
	...
	<div class="main-content main-frm">
		<form class="frm-form" method="post" accept-charset="utf-8" action="<?php echo forum_link('admin/groups.php') ?>?action=foo">
			<div class="hidden">
				<input type="hidden" name="csrf_token" value="<?php echo generate_form_token(forum_link('admin/groups.php').'?action=foo') ?>" />
			</div>
...
while ($cur_group = $forum_db->fetch_assoc($result))
{
	...
	$forum_page['group_options']['edit'] = '<span'.((empty($forum_page['group_options'])) ? ' class="item1"' : '').'><a href="'.forum_link('admin/groups.php').'?edit_group='.$cur_group['g_id'].'">'.$lang_admin_groups['Edit group'].'</a></span>';

	if ($cur_group['g_id'] > FORUM_GUEST)
		$forum_page['group_options']['remove'] = $cur_group['g_id'] != $forum_config['o_default_user_group'] ? '<span'.((empty($forum_page['group_options'])) ? ' class="item1"' : '').'><a href="'.forum_link('admin/groups.php').'?del_group='.$cur_group['g_id'].'&amp;csrf_token='.generate_form_token('del_group'.$cur_group['g_id']).'">'.$lang_admin_groups['Remove group'].'</a></span>' : '<span'.((empty($forum_page['group_options'])) ? ' class="item1"' : '').'>'.$lang_admin_groups['Cannot remove default'].'</span>';
	else
